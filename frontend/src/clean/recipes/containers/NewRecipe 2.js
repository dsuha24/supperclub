...
const NewRecipe = () => {
    ...
    const placeSubmitHandler = async (event) => {
        ...
        try {
            ...
            formData.append(
                "ingredientQty1",
                formState.inputs.ingredientQty1.value
            );
            formData.append(
                "ingredientUnits1",
                formState.inputs.ingredientUnits1.value
            );

            formData.append("ingredient2", formState.inputs.ingredient2.value);
            formData.append(
                "ingredientQty2",
                formState.inputs.ingredientQty2.value
            );
            formData.append(
                "ingredientUnits2",
                formState.inputs.ingredientUnits2.value
            );
